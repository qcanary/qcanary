    ...
    <main id="main-content" className="min-h-screen bg-bg text-text-primary">
      ...
      <section className="overflow-hidden border-b border-border bg-gradient-to-br from-surface/20 via-bg to-code-bg">
        <div className="relative mx-auto w-full max-w-6xl px-6 py-20 md:py-28">
          ...
          <div className="mx-auto mb-16 max-w-4xl rounded-2xl border border-red-500/15 bg-gradient-to-br from-red-500/5 to-code-bg p-8 md:p-10">
            <div className="mb-2 flex items-center gap-2">
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              <div className="flex items-start gap-3 rounded-lg border border-border bg-surface/40 p-4">
                ...
                <div>
                  <div className="text-sm font-medium text-text-primary">Credential exposure</div>
                  <div className="mt-0.5 text-xs text-text-muted">Handing over your Redis URL grants full database access to a third party</div>
                </div>
              </div>
              <div className="flex items-start gap-3 rounded-lg border border-border bg-surface/40 p-4">
                <span className="mt-0.5 shrink-0 text-red-400">✕</span>
                <div>
                  <div className="text-sm font-medium text-text-primary">Network blast radius</div>
                  <div className="mt-0.5 text-xs text-text-muted">Opening port 6379 to a vendor requires VPC peering or public exposure</div>
                </div>
              </div>
              <div className="flex items-start gap-3 rounded-lg border border-border bg-surface/40 p-4">
                <span className="mt-0.5 shrink-0 text-red-400">✕</span>
                <div>
                  <div className="text-sm font-medium text-text-primary">Compliance violation</div>
                  <div className="mt-0.5 text-xs text-text-muted">Storing production Redis credentials in a third-party system violates SOC 2</div>
                </div>
              </div>
              <div className="flex items-start gap-3 rounded-lg border border-border bg-surface/40 p-4">
                <span className="mt-0.5 shrink-0 text-red-400">✕</span>
                <div>
                  <div className="text-sm font-medium text-text-primary">Data leakage</div>
                  <div className="mt-0.5 text-xs text-text-muted">Job payloads, worker metadata, and internals exposed to external monitoring</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="mx-auto max-w-4xl">
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <div className="rounded-xl border border-border bg-gradient-to-br from-surface/60 to-code-bg p-5 transition-all hover:border-accent/30">
                ...
                <div className="mt-3 flex flex-wrap gap-2">
                  {["completed", "failed", "stalled", "active", "waiting", "delayed"].map((evt) => (
                    <span key={evt} className="rounded-md border border-border bg-code-bg px-2.5 py-1 font-mono text-xs text-text-primary">
                      {evt}
                    </span>
                  ))}
                </div>
              ...
              <div className="rounded-xl border border-border bg-gradient-to-br from-surface/60 to-code-bg p-5 transition-all hover:border-accent/30">
                <div className="text-xs font-medium uppercase tracking-wider text-accent">Data Sent</div>
                <div className="mt-3 flex flex-wrap gap-2">
                  <span className="rounded-md border border-border bg-code-bg px-2.5 py-1 font-mono text-xs text-text-primary">jobId</span>
                  <span className="rounded-md border border-border bg-code-bg px-2.5 py-1 font-mono text-xs text-text-primary">queueName</span>
                  <span className="rounded-md border border-border bg-code-bg px-2.5 py-1 font-mono text-xs text-text-primary">status</span>
                  <span className="rounded-md border border-border bg-code-bg px-2.5 py-1 font-mono text-xs text-text-primary">durationMs</span>
                  <span className="rounded-md border border-border bg-code-bg px-2.5 py-1 font-mono text-xs text-text-primary">errorMessage</span>
                </div>
                <p className="mt-3 text-xs text-text-muted">
      ...
      <section className="border-y border-border bg-gradient-to-b from-surface/30 via-bg to-surface/30">
        <div className="relative mx-auto flex w-full max-w-6xl flex-col items-center px-6 py-16 md:py-20">
          ...
          <div className="pointer-events-none absolute -left-20 top-[-40px] h-60 w-60 rounded-full bg-accent/[0.04] blur-3xl" />
          <div className="pointer-events-none absolute -right-20 bottom-[-40px] h-60 w-60 rounded-full bg-accent/[0.02] blur-3xl" />
            ...
            {[
              ...
              <div key={item.step} className="relative flex-1 pb-8 md:pb-0 md:px-3">
                ...
                <div className="flex items-start gap-4 md:flex-col md:items-center md:text-center">
                  {/* Dot */}
                  <div className="relative z-10 flex h-10 w-10 shrink-0 items-center justify-center rounded-full border-2 border-accent/30 bg-bg">
                  ...
                  <div className="min-w-0 flex-1 md:mt-4">
                    ...
                    {/* Code snippet */}
                    <div className="mt-2 inline-block rounded-md border border-border bg-code-bg px-2.5 py-1 font-mono text-xs text-accent">
                      {item.code}
                    </div>
                  </div>
                </div>
      ...
      <section className="border-y border-border bg-gradient-to-t from-surface/30 to-bg">
        <div className="mx-auto w-full max-w-6xl px-6 py-16 md:py-20">
          ...
          {/* Indicators — honest, verifiable facts */}
          <div className="mb-10 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            {/* Open Source */}
            <div className="group rounded-xl border border-border bg-surface/40 p-5 transition-all hover:border-accent/30">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <div className="text-xs text-text-muted">MIT-licensed on GitHub</div>
                </div>
              </div>
            </div>
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-2">
              {["BullMQ", "Node.js", "Redis", "TypeScript", "Docker", "Express", "npm", "pnpm"].map((tech) => (
      ...
      <section className="section-glow overflow-hidden border-y border-border bg-gradient-to-br from-bg via-surface/10 to-code-bg">
        <div className="mx-auto w-full max-w-6xl px-6 py-16 md:py-20">
          ...
          <div className="mb-6 grid gap-5 md:grid-cols-2">
            <div className="card-hover group rounded-xl border border-border bg-gradient-to-br from-surface/60 to-code-bg p-6">
              ...
              <div className="mt-4 flex items-center gap-2 text-xs text-text-muted">
                <span className="rounded-md bg-accent/10 px-2.5 py-0.5 font-mono text-accent ring-1 ring-accent/20">completed</span>
            ...
            <div className="card-hover group rounded-xl border border-border bg-gradient-to-br from-surface/60 to-code-bg p-6">
              ...
              <div className="mt-4 flex items-center gap-2 text-xs text-text-muted">
                <span className="rounded-md bg-accent/10 px-2.5 py-0.5 font-mono text-accent ring-1 ring-accent/20">Slack</span>
          ...
          <div className="mb-6 rounded-xl border border-accent/20 bg-gradient-to-r from-accent/5 via-surface/30 to-code-bg p-6 transition-all hover:border-accent/30 md:p-8">
          ...
          <div className="grid gap-4 md:grid-cols-3">
            <div className="card-hover group rounded-xl border border-border bg-surface/30 p-5">
        ...
        <div className="mx-auto w-full max-w-6xl px-6 py-16 md:py-20">
          ...
          <div className="grid gap-5 md:grid-cols-2">
            {[
              ...
              <div key={t.name} className="flex flex-col rounded-xl border border-border bg-surface/30 p-6 transition-all hover:border-accent/20">
                {/* Quote */}
      ...
      <section className="border-y border-border bg-gradient-to-b from-surface/20 to-bg">
        <div className="mx-auto w-full max-w-3xl px-6 py-16 md:py-20">
          ...
          <div className="space-y-3">
            <details className="group cursor-pointer rounded-xl border border-border bg-surface/30 transition-colors hover:border-accent/30">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-medium text-text-primary [&::-webkit-details-marker]:hidden">
                Do I need to share Redis credentials?
                <svg className="h-4 w-4 shrink-0 text-text-muted transition-transform group-open:rotate-180" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
              </summary>
              <div className="border-t border-border px-5 py-4 text-sm leading-relaxed text-text-muted">
                No. The Qcanary agent listens to BullMQ events inside your app and sends only lightweight metadata to the API. Your Redis URL stays in your environment and is never shared.
              </div>
            </details>
            <details className="group cursor-pointer rounded-xl border border-border bg-surface/30 transition-colors hover:border-accent/30">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-medium text-text-primary [&::-webkit-details-marker]:hidden">
              ...
              <div className="border-t border-border px-5 py-4 text-sm leading-relaxed text-text-muted">
                Most teams install and send first events in under 10 minutes. It&apos;s a 3-line setup: install the package, initialize with your API key, and pass your BullMQ queues.
              </div>
            </details>
            <details className="group cursor-pointer rounded-xl border border-border bg-surface/30 transition-colors hover:border-accent/30">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-medium text-text-primary [&::-webkit-details-marker]:hidden">
              ...
              <div className="border-t border-border px-5 py-4 text-sm leading-relaxed text-text-muted">
                Starter and Pro plans include Slack and email alerts. Pro adds webhook alerts for PagerDuty, OpsGenie, or custom integrations. Free plan intentionally excludes alerts.
              </div>
            </details>
            <details className="group cursor-pointer rounded-xl border border-border bg-surface/30 transition-colors hover:border-accent/30">
              <summary className="flex items-center justify-between px-5 py-4 text-sm font-medium text-text-primary [&::-webkit-details-marker]:hidden">
                Can I view failed job details?
                <svg className="h-4 w-4 shrink-0 text-text-muted transition-transform group-open:rotate-180" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
              </summary>
              <div className="border-t border-border px-5 py-4 text-sm leading-relaxed text-text-muted">
                Yes. Every plan includes job-level detail and stack traces for failed jobs. You can inspect the full error message, the number of attempts, and the job metadata from the dashboard.
              </div>
            </details>
          </div>
        </div>
