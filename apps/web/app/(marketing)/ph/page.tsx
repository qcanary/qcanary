      ...
      <section className="border-b border-border bg-gradient-to-b from-surface/20 to-bg">
        <div className="mx-auto max-w-6xl px-6 py-16 md:py-20">
          <div className="mx-auto max-w-3xl">
            <h2 className="mb-6 text-2xl font-semibold tracking-tight md:text-3xl">Why I built this</h2>
            <div className="space-y-4 text-base leading-relaxed text-text-primary md:text-lg">
              <p>
                ...
                That&rsquo;s full database access. My security team flagged it every time.
              </p>
              <p>
