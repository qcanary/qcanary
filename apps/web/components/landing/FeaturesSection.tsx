    ...
    <section className="overflow-hidden border-y border-border bg-surface/50">
      <div className="mx-auto w-full max-w-6xl px-6 py-16 md:py-20">
        <div className="mb-12 max-w-2xl">
          <h2 className="text-3xl font-bold tracking-tight text-text-primary md:text-4xl">What you actually need</h2>
        ...
        <div className="mb-6 grid gap-5 md:grid-cols-2">
          <div className="group rounded-xl border border-border bg-surface/50 p-6 transition-all hover:border-accent/30">
            <div className="mb-3 flex h-10 w-10 items-center justify-center rounded-xl bg-accent/10 text-accent">
              <BarChart3 className="h-5 w-5" />
            </div>
            <h3 className="text-base font-semibold text-text-primary">See every job. As it happens.</h3>
            ...
            <div className="mt-3 grid grid-cols-2 gap-x-3 gap-y-1.5 overflow-hidden transition-all duration-300 max-h-0 group-hover:max-h-32 opacity-0 group-hover:opacity-100">
              <div className="flex items-center gap-1.5 text-xs text-text-muted"><div className="h-1.5 w-1.5 shrink-0 rounded-full bg-accent/60" /><span>Throughput charts</span></div>
              <div className="flex items-center gap-1.5 text-xs text-text-muted"><div className="h-1.5 w-1.5 shrink-0 rounded-full bg-accent/60" /><span>Failure trends</span></div>
              <div className="flex items-center gap-1.5 text-xs text-text-muted"><div className="h-1.5 w-1.5 shrink-0 rounded-full bg-accent/60" /><span>Job history</span></div>
              <div className="flex items-center gap-1.5 text-xs text-text-muted"><div className="h-1.5 w-1.5 shrink-0 rounded-full bg-accent/60" /><span>Queue health</span></div>
            </div>
          </div>
          ...
          <div className="group rounded-xl border border-border bg-surface/50 p-6 transition-all hover:border-accent/30">
            ...
            <h3 className="text-base font-semibold text-text-primary">Fire alerts on failure rate, stalls, or silence.</h3>
            ...
            <div className="mt-3 grid grid-cols-2 gap-x-3 gap-y-1.5 overflow-hidden transition-all duration-300 max-h-0 group-hover:max-h-32 opacity-0 group-hover:opacity-100">
              <div className="flex items-center gap-1.5 text-xs text-text-muted"><div className="h-1.5 w-1.5 shrink-0 rounded-full bg-accent/60" /><span>Failure rate</span></div>
              <div className="flex items-center gap-1.5 text-xs text-text-muted"><div className="h-1.5 w-1.5 shrink-0 rounded-full bg-accent/60" /><span>Queue stall</span></div>
              <div className="flex items-center gap-1.5 text-xs text-text-muted"><div className="h-1.5 w-1.5 shrink-0 rounded-full bg-accent/60" /><span>Job duration</span></div>
              <div className="flex items-center gap-1.5 text-xs text-text-muted"><div className="h-1.5 w-1.5 shrink-0 rounded-full bg-accent/60" /><span>Auto-resolve</span></div>
            </div>
          </div>
        </div>

        {/* Feature 3 — full-width highlight card */}
        <div className="group mb-6 rounded-xl border border-accent/20 bg-accent/[0.03] p-6 md:p-8 transition-all hover:border-accent/40">
          <div className="flex flex-col items-start gap-4 md:flex-row md:items-center md:gap-6">
            <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl bg-accent/15">
              <Shield className="h-6 w-6 text-accent" />
            </div>
            <div className="flex-1">
              <h3 className="text-base font-semibold text-text-primary">Your Redis never leaves your network.</h3>
        ...
        <div className="grid gap-4 md:grid-cols-3">
          <div className="group rounded-xl border border-border bg-surface/30 p-5 transition-all hover:border-accent/30">
