    ...
    <section className="overflow-hidden border-y border-border bg-surface/50">
      <div className="mx-auto w-full max-w-6xl px-6 py-16 md:py-20">
        ...
        <div className="mb-6 grid gap-5 md:grid-cols-2">
          <TiltCard>
            <div className="group animate-fade-in-up rounded-xl border border-border bg-surface/50 p-6 h-full">
          ...
          <TiltCard>
          <div className="group animate-fade-in-up-delay-1 rounded-xl border border-border bg-surface/50 p-6 h-full">
            <div className="mb-3 flex h-10 w-10 items-center justify-center rounded-xl bg-accent/10 text-accent">
        ...
        <div className="group animate-fade-in-up-delay-2 mb-6 rounded-xl border border-accent/20 bg-accent/[0.03] p-6 md:p-8">
        ...
        <div className="grid gap-4 md:grid-cols-3">
          <div className="group animate-fade-in-up rounded-xl border border-border bg-surface/30 p-5">
          ...
          <div className="group animate-fade-in-up-delay-1 rounded-xl border border-border bg-surface/30 p-5">
            <div className="mb-3 flex h-9 w-9 items-center justify-center rounded-xl bg-accent/10 text-accent">
          ...
          <div className="group animate-fade-in-up-delay-2 rounded-xl border border-border bg-surface/30 p-5">
            <div className="mb-3 flex h-9 w-9 items-center justify-center rounded-xl bg-accent/10 text-accent">
