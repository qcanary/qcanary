...
const COMPARISON_ROWS = [
  ...
  { feature: "History", free: "7 days", solo: "30 days", team: "60 days", business: "365 days", enterprise: "Unlimited" },
  { feature: "Team members", free: "1", solo: "1", team: "5", business: "20", enterprise: "Unlimited" },
  { feature: "Email alerts", free: "3 rules", solo: "Unlimited", team: "Unlimited", business: "Unlimited", enterprise: "Unlimited" },
...
const FAQS = [
  {
    ...
    a: "Solo gives you 5 queues (vs. 1), 30-day history (vs. 7 days), 25,000 events/day (vs. 5,000), unlimited alert rules with Slack, Email + Webhook alerts, and basic 48h support.",
  },
  {
            ...
            offers: [
              {
                ...
                price: "0",
                priceCurrency: "USD",
                description: "1 project, 1 queue, 5K events/day, 7-day history, 3 alert rules + Slack.",
              },
              {
                "@type": "Offer",
                name: "Solo",
                ...
                description: "1 project, 5 queues, 25K events/day, 30-day history, unlimited alerts + Webhooks.",
              },
              {
                "@type": "Offer",
                name: "Team",
                ...
                priceCurrency: "USD",
                priceInterval: "Monthly",
                description: "3 projects, 10 queues/project, 100K events/day, 60-day history, Slack + Email + Webhook alerts.",
              },
              {
                "@type": "Offer",
                name: "Business",
                ...
                priceCurrency: "USD",
                priceInterval: "Monthly",
                description: "Unlimited projects & queues, unlimited events, 365-day history, SSO + RBAC.",
              },
              {
                "@type": "Offer",
                name: "Enterprise",
